...
export const Homebody = () => {
    return(
        <div style={{width: '100%', height: '100%', paddingLeft: 36, paddingRight: 36, paddingTop: 160, paddingBottom: 160, backgroundImage: 'url(https://via.placeholder.com/1440x890)', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'inline-flex'}}>
    <div style={{padding: 20, background: '#FAEDCD', borderRadius: 30, flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: 10, display: 'flex'}}>
        <div style={{width: 349, height: 153, position: 'relative'}}>
            <div style={{width: 308, height: 85, left: 41, top: 68, position: 'absolute', color: 'black', fontSize: 64, fontFamily: 'Climate Crisis', fontWeight: '400', wordWrap: 'break-word'}}>Closet</div>
            <div style={{width: 142, height: 88, left: 0, top: 0, position: 'absolute', color: 'black', fontSize: 64, fontFamily: 'Climate Crisis', fontWeight: '400', wordWrap: 'break-word'}}>my</div>
        </div>
